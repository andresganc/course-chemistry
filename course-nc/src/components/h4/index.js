...
// ==== TYPES ====
    ...
    const fontSize1 = css ` font-size: 2.8rem; font-weight: bold; `
    const fontSize2 = css ` font-size: 2.6rem; font-weight: bold; `
    const fontSize3 = css ` font-size: 2.4rem; font-weight: bold; `
    const fontSize4 = css ` font-size: 2.2rem; font-weight: bold; `
    const fontSize5 = css ` font-size: 2rem; font-weight: bold; `
    const fontSize6 = css ` font-size: 1.8rem; font-weight: bold; `
    const fontSize7 = css ` font-size: 1.6rem; font-weight: bold; `
    const fontSize8 = css ` font-size: 1.4rem; font-weight: bold; `
    const fontSize9 = css ` font-size: 1.2rem; font-weight: bold; `
    const fontSize10 = css ` font-size: 1rem; font-weight: bold; `
