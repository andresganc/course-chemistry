...
// ================== PROPS EXCLUSIVES ==================
// ==== TYPES ====
    const textBase = css ` font-size: 1.5rem; margin: 0px; padding: 0px;`
    const fontSize1 = css ` font-size: 2.3rem; font-weight: bold; `
    const fontSize2 = css ` font-size: 2.1rem; font-weight: bold; `
    const fontSize3 = css ` font-size: 1.9rem; font-weight: bold; `
    const fontSize4 = css ` font-size: 1.7rem; font-weight: bold; `
    const fontSize5 = css ` font-size: 1.5rem; font-weight: bold; `
    const fontSize6 = css ` font-size: 1.3rem; font-weight: bold; `
    const fontSize7 = css ` font-size: 1.1rem; font-weight: bold; `
    const fontSize8 = css ` font-size: .9rem; font-weight: bold; `
    const fontSize9 = css ` font-size: .7rem; font-weight: bold; `
    const fontSize10 = css ` font-size: .5rem; font-weight: bold; `
