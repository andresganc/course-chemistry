...
// ================== PROPS EXCLUSIVES ==================
// ==== TYPES ====
    const textBase = css ` font-size: 3.5rem; margin: 0px; padding: 0px;`
    const fontSize1 = css ` font-size: 4.3rem; font-weight: bold; `
    const fontSize2 = css ` font-size: 4.1rem; font-weight: bold; `
    const fontSize3 = css ` font-size: 3.9rem; font-weight: bold; `
    const fontSize4 = css ` font-size: 3.7rem; font-weight: bold; `
    const fontSize5 = css ` font-size: 3.5rem; font-weight: bold; `
    const fontSize6 = css ` font-size: 3.3rem; font-weight: bold; `
    const fontSize7 = css ` font-size: 3.1rem; font-weight: bold; `
    const fontSize8 = css ` font-size: 2.9rem; font-weight: bold; `
    const fontSize9 = css ` font-size: 2.7rem; font-weight: bold; `
    const fontSize10 = css ` font-size: 2.5rem; font-weight: bold; `
